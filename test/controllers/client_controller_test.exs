defmodule UeberauthProvider.ClientControllerTest do
  use UeberauthProvider.ConnCase

  alias UeberauthProvider.Client
  @valid_attrs %{name: "some content", redirect_uri: "some content", scopes: "some content", secret: "some content", uid: "some content"}
  @invalid_attrs %{}
